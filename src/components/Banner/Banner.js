            ...
            <div className="row">
                ...
                <div className="col-lg-6 bg-right ">
                    <h1 className=''>
                        ...
                        every classroom.
                        Real results.</h1>
                    <p className='fs-5'>We’re a nonprofit with the mission to provide a free, world-class education for anyone, anywhere.</p>
                    <Button className='px-5 py-2 fs-4' variant="primary">Learner Start Here</Button>{' '}
                </div>
            </div>
        </div>
    );
